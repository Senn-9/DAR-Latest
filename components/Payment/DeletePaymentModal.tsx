...
export default function DeletePaymentModal({
  ...
  useEffect(() => {
    ...
    fetchPaymentDeletePreview(deliveryId)
      .then((p) => {
        ...
        setRemarkText(`[DELETED by ${actor}] Payment: ${no}`);
      })
  ...
  const affectedRows = preview ? [
    { label: "Voucher",       count: preview.voucherCount ?? 0 },
    { label: "ORS Documents", count: preview.orsCount     ?? 0 },
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold tracking-widest uppercase text-red-200">Admin · Delete Payment</p>
