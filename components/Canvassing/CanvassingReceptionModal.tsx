...
export default function CanvassingReceptionModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Update purchase_requests status to 8 (Canvassing Releasing)
      ...
      // Create canvass session with bac_no
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative z-[70] bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 mb-6">
              Canvassing reception for PR {currentPrNo} has been completed successfully. Moving to releasing phase.
            </p>
            <button
