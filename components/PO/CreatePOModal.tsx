...
const editableInputCls = "border-b border-gray-400 bg-transparent px-1 py-0 text-inherit font-inherit focus:outline-none focus:border-emerald-500 focus:bg-emerald-50/30 transition-colors min-w-[60px]";
            ...
            return (
              <React.Fragment key={itemKey}>
                ...
                {textOnlyLines
                  ...
                  .map((line) => (
                    <tr key={`text-${line.id}`} style={{ height: "auto", backgroundColor: "#fefce8" }}>
                      <td style={{ border: "1px solid #111", verticalAlign: "top", padding: "2px", textAlign: "center", fontSize: "9pt" }}>
                        <input
                          type="text"
                          value={line.stock_no}
                          onChange={(e) => updateTextOnlyLine(line.id, 'stock_no', e.target.value)}
                          placeholder="Stock No."
                          className={editableInputCls}
                          style={{ width: "90%", textAlign: "center", fontStyle: "italic", color: "#666" }}
                        />
                      </td>
                      <td style={{ border: "1px solid #111", verticalAlign: "top", padding: "2px", textAlign: "center", fontSize: "9pt" }}>
                        <input
                      ...
                      <td style={{ border: "1px solid #111", verticalAlign: "top", padding: "2px", textAlign: "left", fontSize: "9pt" }}>
                        <input
                          ...
                          className={editableInputCls}
                          style={{ width: "95%", fontStyle: "italic", color: "#666" }}
                        />
                      </td>
                      <td style={{ border: "1px solid #111", verticalAlign: "top", padding: "2px", textAlign: "center", fontSize: "9pt" }}>
                        <input
                          ...
                          placeholder="Qty"
                          className={editableInputCls}
                          style={{ width: "80%", textAlign: "center", fontStyle: "italic", color: "#666" }}
                        />
                      </td>
                      <td style={{ border: "1px solid #111", verticalAlign: "top", padding: "2px", textAlign: "center", fontSize: "9pt" }}>
                        <input
                          ...
                          onChange={(e) => updateTextOnlyLine(line.id, 'unit_price', e.target.value)}
                          placeholder="Unit Cost"
                          className={editableInputCls}
                          style={{ width: "80%", textAlign: "right", fontStyle: "italic", color: "#666" }}
                        />
                      </td>
                      <td style={{ border: "1px solid #111", verticalAlign: "top", padding: "4px", textAlign: "center", fontSize: "9pt" }}>
                        <button
...
// Original read-only POPreview component (kept for reference/backup)
function POPreview({
  supplier,
  address,
  tin,
    ...
    for (const line of linesAfterThisItem) {
      ...
      if (hasContent) {
        ...
        <tr style="background-color:#fefce8">
          <td style="border:1px solid #111;vertical-align:top;padding:3px 4px;font-size:9pt;white-space:pre-wrap;text-align:center;font-style:italic;color:#666">${escapeHtml(line.stock_no)}</td>
          <td style="border:1px solid #111;vertical-align:top;padding:3px 4px;font-size:9pt;white-space:pre-wrap;text-align:center;font-style:italic;color:#666">${escapeHtml(line.unit)}</td>
          <td style="border:1px solid #111;vertical-align:top;padding:3px 4px;font-size:9pt;white-space:pre-wrap;font-style:italic;color:#666">${escapeHtml(line.description)}</td>
          <td style="border:1px solid #111;vertical-align:top;padding:3px 4px;font-size:9pt;text-align:right;font-style:italic;color:#666">${escapeHtml(line.quantity)}</td>
          <td style="border:1px solid #111;vertical-align:top;padding:3px 4px;font-size:9pt;text-align:right;font-style:italic;color:#666">${escapeHtml(line.unit_price)}</td>
