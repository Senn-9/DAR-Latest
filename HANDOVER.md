...
### 1. BAC Resolution Workflow (Major Feature)

#### Components Modified:

**`components/Canvassing/ResolutionModal.tsx`** (NEW)
- Created a standalone modal for BAC Resolution submission
...
- `division_id` ← NEW: populated from currentUser
...
**New Files:**
- `components/Canvassing/ResolutionModal.tsx`
...
- Props: `open`, `onClose`, `prId`, `prNo`, `onSubmitted`
...
- Props: `prId`, `prNo`, `canCompleteWorkflow`, `onWorkflowComplete`, `onSubmit`, `hideActions`
