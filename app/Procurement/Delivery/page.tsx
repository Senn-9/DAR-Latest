  ...
  const handleCreateDelivery = async () => {
    ...
    try {
      ...
      if (errorMessage.includes("active delivery process")) {
        ...
        alert("System encountered a temporary issue generating a delivery number. Please try again in a moment.");
      } else if (errorMessage.includes("Failed to create delivery after multiple attempts")) {
        alert("System is experiencing high load. Please wait a few seconds and try again.");
      } else {
        alert(errorMessage);
      }
