...
const navItems = [
  { id: "dashboard", label: "Dashboard", href: "/dashboard", icon: <RiDashboardLine size={25} /> },
  { id: "procurement", label: "Procurement", href: "/dashboard/procurement", icon: <RiFileList3Line size={25} /> },
  { id: "budget", label: "Budget", href: "/dashboard/budget", icon: <RiMoneyDollarCircleLine size={25} /> },
  { id: "calendar", label: "Calendar", href: "/dashboard/calendar", icon: <RiCalendarLine size={25} /> },
  { id: "access logs", label: "Access Logs", href: "/dashboard/accessLogs", icon: <RiFileTextLine size={25} /> },
];
