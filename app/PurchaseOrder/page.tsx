                  ...
                  <thead>
                    <tr className="bg-emerald-700 text-white uppercase tracking-widest">
                      {([
                        ...
                        { label: "Actions",     field: null,                          align: "text-center", width: "w-32" },
                        ...
                        <tr key={index} className="tr-row border-b border-gray-100 transition-colors hover:bg-emerald-50/50">
                          ...
                          <td className={`px-2 py-2 text-center ${rowBg}`}>
                            <button
                              ...
                              className="px-2 py-1 text-xs font-semibold text-gray-600 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded transition-colors inline-flex items-center gap-1"
                            >
                              <RiEyeLine size={14} />
                              View
                            </button>
