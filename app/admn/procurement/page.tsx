...
import {
  ...
  RiEditLine, RiArrowDownSLine, RiArrowUpSLine, RiEyeLine,
} from 'react-icons/ri'
        ...
        <div className="bg-emerald-700 px-6 py-4 flex items-center justify-between flex-shrink-0">
          <div>
            <h2 className="text-white font-bold text-base tracking-wide">
              {mode === 'view' ? 'View Purchase Request' : mode === 'edit' ? 'Edit Purchase Request' : 'New Purchase Request'}
            </h2>
          ...
          <div className={`flex-1 overflow-y-auto bg-gray-100 p-6 ${tab === 'preview' ? 'block' : 'hidden'} md:block`}>
            ...
            <div className="bg-white shadow-lg rounded-lg p-8 text-black max-w-4xl mx-auto">
              ...
              <div className="border-t pt-4">
                <p className="font-semibold text-xs text-gray-600 mb-2">PURPOSE</p>
    ...
    async (pr: PRRecord) => {
      try {
        ...
        if (isUpdate && pr.id) {
          ...
          // Delete old items - wait for completion
          const { error: deleteError } = await supabase
            .from('purchase_request_items')
            .delete()
            .eq('pr_id', parseInt(pr.id))
      ...
      <div className="flex flex-col gap-6 p-6">
        ...
        <div className="flex items-center justify-between border-b border-gray-200">
          ...
          <button
            ...
            className="px-5 py-2 bg-emerald-700 hover:bg-emerald-800 text-white rounded-lg font-semibold text-sm transition-colors whitespace-nowrap mr-4"
          >
            + Create
          </button>
        </div>
