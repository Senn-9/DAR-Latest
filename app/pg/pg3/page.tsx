...
export default function PRModalComponent({
  onSave,
}: {
  onSave?: () => void;
}) {
  ...
  return (
    <>
      ...
      />
      <button onClick={() => setModalOpen(true)} className="flex items-center gap-2 bg-emerald-700 hover:bg-emerald-800 text-white px-6 py-3 rounded-lg font-bold text-base transition-colors">
